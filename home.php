...
$current_category_slug = sanitize_key((string) get_query_var('category_name', ''));
    ...
    <div class="slz-container">
        <div class="slz-filter">
            ...
            <?php foreach ($categories as $category) : ?>
                <a class="slz-chip <?php echo $current_category_slug === $category->slug ? 'active' : ''; ?>" href="<?php echo esc_url(add_query_arg('category_name', $category->slug, $posts_page_url)); ?>"><?php echo esc_html($category->name); ?></a>
            <?php endforeach; ?>
        </div>
